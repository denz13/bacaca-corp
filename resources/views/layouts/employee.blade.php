...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Employee Portal - Bacaca Corp')">
    <meta name="keywords" content="@yield('meta_keywords', 'employee portal, payroll, attendance, dashboard')">
    <meta name="author" content="@yield('meta_author', 'Bacaca Corp')">
    ...
    <!-- Page Title -->
    <title>{{ $title ?? 'Employee Portal - Bacaca Corp' }}</title>
